...
export const metadata: Metadata = {
  ...
  description:
    "Submit a sponsorship request for 70 for 22. All sponsorship proposals are individually reviewed before acceptance.",
    ...
    <section className="py-16 sm:py-20">
      <Container className="max-w-3xl">
        <SectionHeading
          ...
          title="Request to Sponsor"
          description="Interested in supporting 70 for 22 as a corporate or in-kind sponsor? Submit a sponsorship request below. All sponsorship proposals are individually reviewed before acceptance — this form does not commit you or the campaign to anything."
        />
