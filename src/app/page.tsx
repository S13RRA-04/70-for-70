    ...
    <>
      ...
      <section id="why-im-doing-this" className="scroll-mt-20 border-y border-ink/10 bg-sand-light py-16 sm:py-20">
        <Container className="grid gap-10 lg:grid-cols-[minmax(0,360px)_1fr] lg:items-center">
          ...
          <div>
            <SectionHeading eyebrow="Who's Behind Tri" title="Why I'm Doing This" />
      ...
      <section className="bg-sand-light py-16 sm:py-20">
        <Container>
          <SectionHeading
            ...
            description="Tri raises funds in support of veteran-focused nonprofit organizations."
          />
      ...
      <section className="py-16 sm:py-20">
        <Container>
          <SectionHeading
            ...
            title="Sponsors"
            description="Organizations and businesses supporting Tri alongside individual donors."
          />
          <div className="mt-8">
      ...
      <section className="py-10">
        <Container className="flex flex-wrap items-center justify-between gap-4">
          ...
          <ShareButtons
            url={SITE_URL}
            title="I'm helping move Tri one mile closer to $70,000 for veterans."
          />
        </Container>
      </section>
