...
export const BIKE_BUILD_STATUS_SUMMARY: BikeBuildStatusSummaryItem[] = [
  {
    ...
    detail: "Donated 2012 Stradalli carbon frame is on the repair stand — wheels, handlebar, seatpost, bottom bracket, aerobars, brifters, crankset, pedals, and saddle are all installed; assembly is underway.",
  },
  {
  ...
  },
  {
    ...
    status: "needed",
    statusLabel: "In Progress",
    detail: "A rim brake set, a replacement seat tube collar, the rear derailleur, the front derailleur, and training tires are ordered and awaiting delivery; only race tires still need to be ordered. The chain, headset spacers, and tubes are already in hand.",
  },
  {
...
export const BIKE_BUILD_COMPONENT_STATUS: BikeBuildComponentRow[] = [
  ...
  },
  {
    ...
    status: "confirmed",
    statusLabel: "Installed",
    notes: "170 mm Praxis Zayante Carbon crankset with 50/34 chainrings — arrived September 2, 2026, installed September 22, 2026.",
  },
  {
  ...
  },
  {
    ...
    status: "needed",
    statusLabel: "Ordered — Awaiting Delivery",
    notes: "Shimano 105 RD-R7000-GS medium cage, 11-speed — ordered September 21, 2026 for $38.62; estimated delivery Monday, September 28, 2026. Not required by the current cassette, but leaves room for a wider-range cassette later.",
  },
  {
    component: "Brake Calipers",
    status: "needed",
    statusLabel: "Ordered — Awaiting Delivery",
    notes: "Shimano 105 BR-R7000/R7010 dual-pivot calipers, front and rear — ordered September 19, 2026 for $62.12; estimated delivery Monday, September 28, 2026.",
  },
  {
  ...
  },
  {
    ...
    status: "confirmed",
    statusLabel: "In Hand",
    notes: "Covered by the same Boao Universal Bike Brake Cable Kit purchased for the shift cables/housing — ordered September 18, 2026, delivered September 20, 2026.",
  },
  {
    component: "Brifters",
    status: "confirmed",
  ...
  },
  {
    ...
    status: "confirmed",
    statusLabel: "Installed",
    notes: "ISM PR 3.0 (60mm), provided by ISM Saddles — arrived August 28, 2026, installed September 22, 2026.",
  },
  {
    component: "Pedals",
    status: "confirmed",
    statusLabel: "Installed",
    notes: "RockBros clipless pedals with cleats, purchased online for $43.19 — arrived September 16, 2026, installed September 22, 2026.",
  },
  {
  ...
  },
  {
    ...
    status: "confirmed",
    statusLabel: "In Hand",
    notes: "ALIEN PROS Chameleon Tail bar tape (set of 2) — purchased September 18, 2026 for $14.40, delivered September 20, 2026.",
  },
  {
    component: "Chain",
    status: "confirmed",
  ...
  },
  {
    ...
    status: "confirmed",
    statusLabel: "In Hand",
    notes: "Peaty's Speed Grease, 100g — ordered September 21, 2026 for $14.03; arrived and used to install the crankset, September 22, 2026.",
  },
  {
...
export const BIKE_BUILD_TIMELINE: BikeBuildTimelineEntry[] = [
  ...
  },
  {
    ...
    title: "Cycling Shoes: Quest Road Shoes",
    summary: "A pair of Quest Road cycling shoes — purchased, not donated — rounding out the connection from pedal to cockpit.",
    status: "Cycling shoes purchased",
    technicalDetails: {
      heading: "Cycling Shoes",
      items: [
        { label: "Model", value: "Men's Quest Road Shoes, black" },
        { label: "Price", value: "$67.19" },
      ],
    },
    body: [
      ...
      "A pair of Quest Road cycling shoes: stiff soles, a proper clipless cleat interface, and the actual connection point between the pedals below and the aero position everything else on this bike is built around.",
  ...
  },
  {
    ...
    body: [
      ...
      "A pair of RockBros clipless pedals, cleats included, arrived the same day the MBC parts started their trip home, for $43.19. Between these and the Quest Road shoes bought a couple weeks earlier, the connection from foot to crank is now fully accounted for.",
  ...
  {
    id: "order-confirmations-catch-up-the-numbers",
    date: "2026-09-22",
    displayDate: "September 22, 2026",
    title: "The Paper Trail Catches Up",
    summary:
      "A batch of order confirmations filled in exact prices and dates across the last week of purchases — and revealed the brake cables were already covered.",
    status: "Costs reconciled",
    costTable: {
      heading: "This Week's Confirmed Purchases",
      note: "Order totals as confirmed by receipt — supersedes any earlier estimates for these items.",
      rows: [
        { part: "Shimano 105 RD-R7000 rear derailleur", cost: "$38.62" },
        { part: "Shimano 105 CN-HG601-11 chain", cost: "$26.48" },
        { part: "Shimano 105 BR-R7000/R7010 brake calipers (front & rear)", cost: "$62.12" },
        { part: "Boao brake/shift cable & housing kit", cost: "$10.76" },
        { part: "ALIEN PROS handlebar tape", cost: "$14.40" },
        { part: "Saipe headset spacers", cost: "$9.71" },
        { part: "PLATT seatpost collar", cost: "$9.71" },
        { part: "Peaty's assembly grease", cost: "$14.03" },
      ],
      totalLabel: "Total, this batch",
      totalValue: "$185.83",
    },
    body: [
      "Assembling a bike from a dozen different online orders means the receipts always lag behind the actual parts. This is the batch of order confirmations catching the numbers up.",
      "The rear derailleur, chain, and brake calipers all now have exact order dates and prices attached instead of estimates: the rear derailleur at $38.62, the chain at $26.48, and a full front-and-rear brake caliper set at $62.12 — all inside or under the estimates from inventory day.",
      "The real find: the cable-and-housing order placed back on September 18 turned out to be a universal kit that covers both shift cables and brake cables — which means brake cables, sitting on the \"needed\" list until now, are actually already in hand.",
  ...
  {
    id: "crankset-pedals-saddle-installed",
    date: "2026-09-23",
    displayDate: "September 22, 2026",
    title: "Crankset, Pedals, and Saddle: On the Bike",
    summary:
    ...
    photos: [
      {
        ...
        alt: "The Stradalli Sorrento frame on the Feedback Sports repair stand with the Praxis crankset, RockBros pedals, and ISM saddle all installed, aerobars and brifters visible on the cockpit.",
        caption: "Crankset, pedals, and saddle — all on the bike now.",
        width: 2016,
        height: 1512,
      },
    ],
    technicalDetails: {
      ...
      items: [
        { label: "Crankset", value: "Praxis Zayante Carbon, 170mm, 50/34 — installed" },
  ...
  {
    id: "the-finish-line-is-in-sight",
    date: "2026-09-25",
    ...
    technicalDetails: {
      ...
      items: [
        { label: "Chain Arrived", value: "September 25, 2026" },
        { label: "Target Build Completion", value: "Weekend of October 3–4, 2026 (if parts arrive on schedule)" },
        { label: "Target First Training Ride", value: "Monday, October 5, 2026" },
      ],
    },
    body: [
      "A small package showed up today, but it represents a pretty big milestone in this build: the drivetrain chain is here.",
      "At this point, the Stradalli is getting very close to becoming a complete bicycle again. The remaining components are inbound, and if everything arrives on schedule, I'm hoping to have the final build completed by next weekend.",
      "It's been a process. What started as an older carbon Stradalli Sorrento frame has slowly turned into a bike again — one component, one cable, and occasionally one incorrectly sized part at a time. I've learned considerably more about bicycle assembly along the way than I expected when I started.",
      "Once the remaining parts arrive, I'll finish the drivetrain, brakes, cabling, and final setup. Then comes the part I've been waiting for: the first test ride.",
      "That ride won't be about speed. It'll be about making sure everything works the way it should — shifting through the full drivetrain, checking brake performance, listening for drivetrain noise, dialing in the cockpit and saddle position, and identifying anything that needs adjustment before I start putting serious miles on it.",
      "If everything goes according to plan, I should begin actually training on the Stradalli by Monday, October 5.",
      "And that's when this project changes.",
      "Until now, I've been building the bike.",
      "Starting in October, I'll be building the engine.",
      "That gives me roughly seven months of consistent training on this bike before the starting line at IRONMAN 70.3 Chattanooga next May. Seven months to get comfortable in the aero position. Seven months to build power and endurance. Seven months to learn exactly how this bike handles, shifts, climbs, descends, and feels when my legs are already tired.",
      "By race day, I don't want the Stradalli to feel like a bike I rebuilt.",
      "I want it to feel like my bike.",
      "The pile of parts is almost gone.",
