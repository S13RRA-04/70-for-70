...
export const BIKE_BUILD_STATUS_SUMMARY: BikeBuildStatusSummaryItem[] = [
  ...
  },
  {
    ...
    status: "needed",
    statusLabel: "In Progress",
    detail: "Chain, a rim brake set, an alloy headset spacer set, a seat tube collar, and the rear derailleur are ordered and awaiting delivery; the front derailleur and tires still need to be ordered.",
  },
  {
...
export const BIKE_BUILD_COMPONENT_STATUS: BikeBuildComponentRow[] = [
  ...
  },
  {
    ...
    status: "needed",
    statusLabel: "Ordered — Awaiting Delivery",
    notes: "PLATT quick-release aluminium alloy seatpost collar (28.6/31.8/34.9 mm), to clamp the Redshift Sports seatpost in the frame — ordered September 21, 2026 for $9.71; expected Tuesday, September 22, 2026.",
  },
  {
    component: "Saddle",
    status: "confirmed",
  ...
  },
  {
    ...
    status: "confirmed",
    statusLabel: "In Hand",
    notes: "RockBros clipless pedals with cleats, purchased online for $43.19 — arrived September 16, 2026.",
  },
  {
  ...
  },
  {
    ...
    status: "needed",
    statusLabel: "Ordered — Awaiting Delivery",
    notes: "Peaty's Speed Grease, 100g — ordered September 21, 2026 for $14.03; expected Tuesday, September 22, 2026.",
  },
  {
    component: "Tires",
    status: "needed",
