...
export const ABOUT_CONTENT: AboutContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Endurance sports became one of the ways I learned to keep putting one foot in front of the other.",
        "I completed my first marathon in 2023. In 2024, I completed a 100-kilometer ultramarathon.",
        "Those experiences taught me something that carries far beyond racing: you do not have to feel strong to keep moving. You just have to take the next step.",
        "There are moments in endurance events when your body is tired, your mind is looking for an exit, and the finish line feels impossibly far away. Life can feel exactly the same way.",
        "The answer is rarely to solve the entire problem at once. Find the next aid station. Reach the next mile marker. Take the next step. Then do it again.",
      ],
    },
    {
      id: "project-echelon",
