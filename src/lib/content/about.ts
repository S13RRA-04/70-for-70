  ...
  sections: [
    {
      ...
      heading: "My Story",
      body: [
        "My name is Cody Hitson. I am a husband, father, Navy veteran, law enforcement professional, and endurance athlete. Over the years, I have worn a lot of different uniforms and carried a lot of different responsibilities, but the part of my story that matters most to Tri is not what I have done.",
    ...
    },
    {
      ...
      body: [
        ...
        "That is one of the reasons Mighty Oaks is part of Tri. I know firsthand what their work can mean to a veteran and a family.",
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        "But I do not want this race to be only about crossing another finish line. I want those miles to mean something. That is where Tri began.",
      ],
    },
    {
      id: "tri",
    ...
    },
    {
      ...
      heading: "The Mission",
      body: [
        "Tri is not about proving how tough I am. I have nothing left to prove in that department.",
