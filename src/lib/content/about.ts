 ...
 * section. The outer ring is every branch of the U.S. Armed Forces; the
 * inner ring is every sector of first-responder service. Colors are keyed
 * to their meaning below rather than to a specific clock position on the
 * mark, since the ring segments aren't easily disambiguated by position
 * alone in the source artwork.
 */
