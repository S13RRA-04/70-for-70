...
export const SEED_MISSION_PARTNERS: MissionPartnerRow[] = [
  {
    ...
    logo_background: null,
    website_url: "https://www.projectechelon.org/",
    support_type: "Lazer Victor KinetiCore aero helmet",
  ...
  {
    id: "seed-mission-partner-praxis",
    name: "Praxis",
    relationship_label: "Advocate",
    description:
      "Praxis is supporting Tri For The 22's race bike build with a carbon crankset and bottom bracket.",
    logo_url: "/partners/praxis-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
    support_type: "Carbon crankset + bottom bracket",
    geographic_scope: null,
    active: true,
    display_order: 1,
    agreement_status: null,
  ...
  {
    id: "seed-mission-partner-tyr",
    name: "TYR",
    relationship_label: "Ally",
    description: "TYR is supporting Tri For The 22 with race-day footwear.",
    logo_url: "/partners/tyr-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
    support_type: "Race-day footwear",
    geographic_scope: null,
    active: true,
    display_order: 2,
    agreement_status: null,
  ...
  {
    id: "seed-mission-partner-feedback-sports",
    name: "Feedback Sports",
    relationship_label: "Ally",
    description: "Feedback Sports is supporting Tri For The 22 with bike maintenance equipment.",
    logo_url: "/partners/feedback-sports-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
    support_type: "Pro Mechanic 2.0 repair stand",
    geographic_scope: null,
    active: true,
    display_order: 3,
    agreement_status: null,
  ...
  {
    id: "seed-mission-partner-ism-saddles",
    name: "ISM Saddles",
    relationship_label: "Campaign Supporter",
    description: "ISM Saddles is supporting Tri For The 22 with a bicycle saddle for the race bike.",
    logo_url: "/partners/ism-saddles-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
    support_type: "Bicycle saddle",
    geographic_scope: null,
    active: true,
    display_order: 4,
    agreement_status: null,
    ...
    associated_campaigns: null,
    partner_type: "gear-partner",
    tier: "campaign-supporter",
    designation: null,
  },
  {
    id: "seed-mission-partner-funky-trunks",
    name: "Funky Trunks",
    relationship_label: "Campaign Supporter",
    description: "Funky Trunks is supporting Tri For The 22 with swim and training gear.",
    logo_url: "/partners/funky-trunks-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
    support_type: "Swim/training gear",
    geographic_scope: null,
    active: true,
    display_order: 5,
    agreement_status: null,
  ...
  },
  {
    ...
    logo_dark_url: null,
    logo_background: null,
    website_url: "https://minuteman.com/",
    support_type: "Exclusive print partner — campaign printing services",
    geographic_scope: null,
    active: true,
    display_order: 8,
    agreement_status: null,
    ...
    relationship_end: null,
    associated_campaigns: null,
    partner_type: "print-partner",
    tier: "advocate",
    designation: "Official Print Partner",
  },
  {
    id: "seed-mission-partner-xterra-wetsuits",
    name: "XTERRA WETSUITS",
    relationship_label: "Swim & Wetsuit Partner",
    description:
      "XTERRA WETSUITS supports Tri For The 22 through its Clubs, Teams & Coaches Program, providing special team pricing on wetsuits, swim apparel and accessories while helping the campaign generate equipment credit for future training and race needs.",
    logo_url: "/partners/xterra-wetsuits-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
    support_type: "Team pricing on wetsuits, swim apparel & accessories",
    geographic_scope: null,
    active: true,
    display_order: 7,
    agreement_status: null,
    ...
    relationship_end: null,
    associated_campaigns: null,
    partner_type: "team-benefit-partner",
    tier: null,
    designation: null,
  },
  {
    id: "seed-mission-partner-swimoutlet",
    name: "SwimOutlet",
    relationship_label: "Campaign Partner",
    description: "SwimOutlet is supporting Tri For The 22 with a custom campaign swim cap.",
    logo_url: "/partners/swimoutlet-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
  ...
  {
    id: "seed-mission-partner-bicycle-cove",
    name: "Bicycle Cove",
    relationship_label: "Campaign Partner",
    description: "Bicycle Cove is a verified campaign partner supporting the race bike build.",
    logo_url: "/partners/bicycle-cove-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
  ...
  {
    id: "seed-mission-partner-redshift-sports",
    name: "Redshift Sports",
    relationship_label: "Campaign Partner",
    description: "Redshift Sports is a verified campaign partner supporting the race bike build.",
    logo_url: "/partners/redshift-sports-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
  ...
  {
    id: "seed-mission-partner-zealios",
    name: "Zealios",
    relationship_label: "Campaign Partner",
    description: "Zealios is a verified campaign partner.",
    logo_url: "/partners/zealios-logo.png",
    logo_light_url: "/partners/zealios-logo-white.png",
    logo_dark_url: "/partners/zealios-logo.png",
    logo_background: null,
    website_url: null,
    support_type: null,
    geographic_scope: null,
  ...
  {
    id: "seed-mission-partner-the-chattanoogan",
    name: "The Chattanoogan",
    relationship_label: "Campaign Partner",
    description: "The Chattanoogan is a verified campaign partner supporting race-weekend logistics.",
    logo_url: "/partners/the-chattanoogan-logo.png",
    logo_light_url: null,
    logo_dark_url: null,
    logo_background: null,
    website_url: null,
