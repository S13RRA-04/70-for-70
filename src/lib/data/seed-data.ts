...
export const SEED_TRAINING_OBJECTIVES: TrainingObjectiveRow[] = [
  ...
  objective("seed-swim-3", "swim", "50m comfortable & repeatable", 2, "done"),
  objective("seed-swim-4", "swim", "100m continuous", 3, "done"),
  objective("seed-swim-5", "swim", "125m continuous", 4, "done"),
  objective("seed-swim-6", "swim", "200m continuous", 5, "done", "Current baseline"),
  objective("seed-swim-7", "swim", "400m continuous", 6, "done"),
  objective("seed-swim-8", "swim", "750m continuous", 7, "done"),
